...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RelationType.is_partner'
        db.add_column(u'users_relationtype', 'is_partner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RelationType.is_partner'
        db.delete_column(u'users_relationtype', 'is_partner')
