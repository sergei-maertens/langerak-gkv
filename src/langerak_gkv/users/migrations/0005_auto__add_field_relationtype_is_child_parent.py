...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RelationType.is_child_parent'
        db.add_column(u'users_relationtype', 'is_child_parent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RelationType.is_child_parent'
        db.delete_column(u'users_relationtype', 'is_child_parent')
