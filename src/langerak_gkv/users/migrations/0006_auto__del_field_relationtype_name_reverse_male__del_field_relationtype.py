...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RelationType.name_reverse_male'
        db.delete_column(u'users_relationtype', 'name_reverse_male')

        # Deleting field 'RelationType.name_reverse_female'
        db.delete_column(u'users_relationtype', 'name_reverse_female')

        # Adding field 'RelationType.reverse'
        db.add_column(u'users_relationtype', 'reverse',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.RelationType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RelationType.name_reverse_male'
        db.add_column(u'users_relationtype', 'name_reverse_male',
                      self.gf('django.db.models.fields.CharField')(default='reverse male', max_length=100),
                      keep_default=False)

        # Adding field 'RelationType.name_reverse_female'
        db.add_column(u'users_relationtype', 'name_reverse_female',
                      self.gf('django.db.models.fields.CharField')(default='reverse female', max_length=100),
                      keep_default=False)

        # Deleting field 'RelationType.reverse'
        db.delete_column(u'users_relationtype', 'reverse_id')
