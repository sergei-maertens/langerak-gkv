...
class LiturgyResource(resources.ModelResource):
    ...
    class Meta:
        model = Liturgy
        fields = ('id', 'date', 'service__name', 'service__time', 'preacher',
                  'preach_author', 'main_section', 'main_chapter', 'main_verse',
                  'service_theme', 'liturgy', 'beamist', 'organist',
                  'collection_goal1', 'collection_goal2', 'collection_goal3',
                  'extra_information')
