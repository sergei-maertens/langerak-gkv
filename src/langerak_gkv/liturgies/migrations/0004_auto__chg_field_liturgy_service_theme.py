...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Liturgy.service_theme'
        db.alter_column(u'liturgies_liturgy', 'service_theme', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Liturgy.service_theme'
        db.alter_column(u'liturgies_liturgy', 'service_theme', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'liturgies.liturgy': {
            ...
            'main_chapter': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            'service_theme': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        },
