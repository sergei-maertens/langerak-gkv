...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Liturgy.internal_remarks'
        db.add_column(u'liturgies_liturgy', 'internal_remarks',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Liturgy.internal_remarks'
        db.delete_column(u'liturgies_liturgy', 'internal_remarks')
    ...
    models = {
        ...
        u'liturgies.liturgy': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'internal_remarks': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
