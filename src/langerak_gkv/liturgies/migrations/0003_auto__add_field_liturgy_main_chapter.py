...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Liturgy.main_chapter'
        db.add_column(u'liturgies_liturgy', 'main_chapter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Liturgy.main_chapter'
        db.delete_column(u'liturgies_liturgy', 'main_chapter')
