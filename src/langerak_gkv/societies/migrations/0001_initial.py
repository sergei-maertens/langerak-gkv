...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'societies_society', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True)),
        ))
        db.send_create_signal(u'societies', ['Society'])

        # Adding M2M table for field members on 'Society'
        m2m_table_name = db.shorten_name(u'societies_society_members')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('society', models.ForeignKey(orm[u'societies.society'], null=False)),
            ('user', models.ForeignKey(orm[u'users.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['society_id', 'user_id'])

        # Adding model 'SocietyPlugin'
        db.create_table(u'societies_societyplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('society', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['societies.Society'])),
            ('page_link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, blank=True)),
        ))
        db.send_create_signal(u'societies', ['SocietyPlugin'])


    def backwards(self, orm):
        # Deleting model 'Society'
        db.delete_table(u'societies_society')

        # Removing M2M table for field members on 'Society'
        db.delete_table(db.shorten_name(u'societies_society_members'))

        # Deleting model 'SocietyPlugin'
        db.delete_table(u'societies_societyplugin')
    ...
    models = {
        ...
        u'societies.society': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['users.User']", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'societies.societyplugin': {
            'Meta': {'object_name': 'SocietyPlugin', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'page_link': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Page']", 'null': 'True', 'blank': 'True'}),
            'society': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['societies.Society']"})
        },
        u'users.district': {
