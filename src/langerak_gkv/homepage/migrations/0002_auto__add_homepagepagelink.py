...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HomepagePageLink'
        db.create_table(u'homepage_homepagepagelink', (
            ...
            ('enable_sharing', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'homepage', ['HomepagePageLink'])


    def backwards(self, orm):
        # Deleting model 'HomepagePageLink'
        db.delete_table(u'homepage_homepagepagelink')
