...
class Migration(DataMigration):
    ...
    models = {
        ...
        u'filer.file': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'owned_files'", 'null': 'True', 'to': u"orm['users.User']"}),
        ...
        u'filer.folder': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'filer_owned_folders'", 'null': 'True', 'to': u"orm['users.User']"}),
        ...
        u'homepage.charfieldplugin': {
            'Meta': {'object_name': 'CharFieldPlugin', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'content': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'homepage.homepagepagelink': {
            'Meta': {'object_name': 'HomepagePageLink', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'enable_sharing': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'homepage.prayerondemand': {
            'Meta': {'object_name': 'PrayerOnDemand'},
        ...
        u'newsletter.submission': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 1, 0, 0)', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        u'newsletter.subscription': {
            ...
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'ae5c4974f80df96b430a0a584c16c2290dce0d24'", 'max_length': '40'}),
    ...
    complete_apps = ['newsletter', 'homepage']
    symmetrical = True
