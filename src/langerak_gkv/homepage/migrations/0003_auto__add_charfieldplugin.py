...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CharFieldPlugin'
        db.create_table(u'homepage_charfieldplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'homepage', ['CharFieldPlugin'])


    def backwards(self, orm):
        # Deleting model 'CharFieldPlugin'
        db.delete_table(u'homepage_charfieldplugin')
