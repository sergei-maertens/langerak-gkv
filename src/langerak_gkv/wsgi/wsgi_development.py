"""
WSGI config for langerak_gkv project.
...
# os.environ["DJANGO_SETTINGS_MODULE"] = "langerak_gkv.settings"
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "langerak_gkv.conf.settings_development")
